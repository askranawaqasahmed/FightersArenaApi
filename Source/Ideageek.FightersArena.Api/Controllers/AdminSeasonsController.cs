...
public class AdminSeasonsController : ApiControllerBase
{
    ...
    public async Task<IActionResult> Update(Guid id, CreateSeasonRequest request)
    {
        ...
        return ApiOk("Season updated", new { id });
    }
    ...
    public async Task<IActionResult> Delete(Guid id)
    {
        ...
        return ApiOk("Season deleted", new { id });
    }
}
